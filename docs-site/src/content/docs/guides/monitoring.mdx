...
flowchart TB
    ...
    classDef containerStyle fill:#e3f2fd,stroke:#2196f3,stroke-width:2px
    classDef collectionStyle fill:#d1fae5,stroke:#059669,stroke-width:2px
    classDef storageStyle fill:#fed7aa,stroke:#ea580c,stroke-width:2px
    classDef vizStyle fill:#fce7f3,stroke:#db2777,stroke-width:2px
...
flowchart LR
    ...
    classDef docker fill:#0db7ed,stroke:#0a7ea3,stroke-width:2px
    classDef promtail fill:#d1fae5,stroke:#059669,stroke-width:2px
    classDef loki fill:#fed7aa,stroke:#ea580c,stroke-width:2px
    classDef grafana fill:#fce7f3,stroke:#db2777,stroke-width:2px
...
flowchart LR
    subgraph docker["`**Docker Metadata**`"]
        direction TB
        D1@{ shape: tag, label: "container_name" }
        D2@{ shape: tag, label: "service" }
        D3@{ shape: tag, label: "project" }
        D4@{ shape: tag, label: "labels" }
    end

    subgraph loki["`**Loki Labels**`"]
        direction TB
        L1@{ shape: tag, label: "container" }
        L2@{ shape: tag, label: "service" }
        L3@{ shape: tag, label: "project" }
        L4@{ shape: tag, label: "group" }
    end
    ...
    classDef dockerStyle fill:#e3f2fd,stroke:#0db7ed,stroke-width:2px
    classDef lokiStyle fill:#fed7aa,stroke:#ea580c,stroke-width:2px
