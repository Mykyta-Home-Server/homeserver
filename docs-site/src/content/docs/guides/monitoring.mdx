...
flowchart TB
    ...
    classDef containerStyle fill:#e3f2fd,stroke:#2196f3,color:#1565c0
    classDef collectionStyle fill:#d1fae5,stroke:#059669,color:#065f46
    classDef storageStyle fill:#fed7aa,stroke:#ea580c,color:#9a3412
    classDef vizStyle fill:#fce7f3,stroke:#db2777,color:#9d174d
...
flowchart LR
    ...
    Container -->|1. Logs| Docker
    Docker -->|2. File| Promtail
    Promtail -->|3. Push| Loki
    Loki -->|4. Store| Loki
    Grafana -->|5. Query| Loki
    Grafana -->|6. Display| User
...
flowchart TB
    ...
    classDef dockerStyle fill:#e3f2fd,stroke:#0db7ed,color:#1565c0
    classDef lokiStyle fill:#fed7aa,stroke:#ea580c,color:#9a3412
