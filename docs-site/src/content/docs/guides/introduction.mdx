...
flowchart TB
    ...
    classDef userStyle fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    classDef processStyle fill:#fef3c7,stroke:#f59e0b,stroke-width:2px
    classDef downloadStyle fill:#a7f3d0,stroke:#10b981,stroke-width:2px
    classDef subtitleStyle fill:#fce7f3,stroke:#ec4899,stroke-width:2px
    classDef streamStyle fill:#e0e7ff,stroke:#8b5cf6,stroke-width:2px
...
flowchart TB
    ...
    style row1_a fill:none,stroke:none
    style row2_a fill:none,stroke:none
    style row1_m fill:none,stroke:none
    style row2_m fill:none,stroke:none
    style row3_m fill:none,stroke:none

    classDef proxyStyle fill:#dbeafe,stroke:#3b82f6,stroke-width:2px
    classDef authStyle fill:#fce7f3,stroke:#ec4899,stroke-width:2px
    classDef mediaStyle fill:#a7f3d0,stroke:#10b981,stroke-width:2px
    classDef monitorStyle fill:#fed7aa,stroke:#f97316,stroke-width:2px
