...
flowchart TB
    ...
    classDef mgmtStyle fill:#9c27b0,stroke:#7b1fa2,stroke-width:2px
    classDef ldapStyle fill:#4caf50,stroke:#388e3c,stroke-width:2px
    classDef ssoStyle fill:#2196f3,stroke:#1976d2,stroke-width:2px
    classDef directStyle fill:#d1fae5,stroke:#059669,stroke-width:2px
    classDef protectedStyle fill:#dbeafe,stroke:#2563eb,stroke-width:2px
...
flowchart TB
    ...
    classDef root fill:#4caf50,stroke:#388e3c,stroke-width:2px
    classDef ou fill:#2196f3,stroke:#1976d2,stroke-width:2px
...
flowchart LR
    ...
    classDef groupStyle fill:#9c27b0,stroke:#7b1fa2,stroke-width:2px
    classDef adminStyle fill:#ffcdd2,stroke:#f44336,stroke-width:2px
    classDef mediaStyle fill:#c8e6c9,stroke:#4caf50,stroke-width:2px
