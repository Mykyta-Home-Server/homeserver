...
```mermaid
flowchart LR
    User([User]) -->|1. Access| Service[Service]
    Service -->|2. Auth check| Authelia[Authelia]
    Authelia -->|3. Validate| LDAP[(LDAP)]
    LDAP -->|4. User + Groups| Authelia
    Authelia -->|5. Session cookie| Service
    Service -->|6. Access granted| User
